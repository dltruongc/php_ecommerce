...
if (isset($_GET["q"])) {
    $dsHangHoa = $hangHoa->timHangHoa($_GET["q"]);
} else {
    $dsHangHoa = $hangHoa->xemHangHoaMoi();
}
        ...
        <div class="row">
            <div class="col-md-12 col-lg-8">
                <div class="title-single-box">
                    <h1 class="title-single">Sản phẩm</h1>
                    <span class="color-text-a">Danh mục các sản phẩm</span>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 d-flex justify-content-end">
                <div class="">
                    <form class="form-inline mb-4" action="product.php" method="get">
                        <div class="form-group mx-sm-3 mb-2">
                            <input class="form-control" placeholder="Tên sản phẩm" type="text" name="q" id="q">
                        </div>
                        <input class="btn btn-info mb-2" type="submit" value="Tìm">
                    </form>
                </div>
            </div>
            <?php
            foreach ($dsHangHoa as $hh) {
                echo "
                    <div class=\"col-md-4\">
