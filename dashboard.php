    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-4">
                <div  class="breadcrumb-box d-flex justify-content-lg-end">
                    <a class="btn btn-primary" href="dashboard_product_add.php">Thêm hàng hóa</a>
                </div>
            </div>
        </div>
        ...
        <div class="row mt-lg-4">
            <div class="col-md-12 col-lg-12">
                <ul class="nav justify-content-around shadow-lg">
                    <li class="nav-item">
                        <a class="nav-link border-dark border-bottom" href="dashboard.php">Hàng hóa</a>
                    </li>
                    <li class="nav-item">
                        ...
                        <tbody>
                            <?php
                                foreach ($results as $hh) {
                                    $dashboard = ROOT_URL . "/dashboard_product.php";
                                    echo "
                                    <tr>
                                    <th scope=\"row\">$hh[0]</th>
                                    <td>$hh[1]</td>
                                    <td>$hh[2]</td>
                                    <td>$hh[3]</td>
                                    <td>$hh[4]</td>
                                    ...
                                    <td>
                                        ...
                                        <div role='group' aria-label='Basic example'> 
                                            <input type='hidden' name='hanghoa' value='$hh[0]' >
                                            <input value='Xem' type='submit' class='btn btn-outline-info' >
                                        </div>
                                        </form>
                                    </td>
                                    </tr>
